...
class PdListBox(CoreGui):
    ...
    def __init__(self, x, y, **kwargs):
        CoreGui.__init__(self, "listbox", x, y, [])
        self._digits = int(kwargs.get("digits", 20))
    ...
    def draw(self, painter):
        ...
        painter.draw_text(self.x + 2, self.top + text_yoff, self.value)
        if self.show_inlets():
    ...
    def to_atoms(self):
        return ["#X", "listbox", self._x, self._y, self._digits,
                self._min, self._max,
