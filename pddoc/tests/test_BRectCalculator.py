...
class TestBRectCalculator(TestCase):
    def test_calc_brect(self):
        ...
        self.assertEqual(br.brect(), (26, 23, 384, 228))

        pnt = CairoPainter(223, 228, "out/objects.png", "png", xoffset=-26, yoffset=-23)
        d = PdDrawer()
        d.draw(p.canvas, pnt)
    ...
    def test_comment_brect(self):
        br = BRectCalculator()
        self.assertEqual(br.text_brect("test"), (0, 0, 29, 15))
        self.assertEqual(br.text_brect("test; line break"), (0, 0, 75, 30))
